...
function EmployerDetails() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("https://jobportal-api-tiu2.onrender.com/app/v1/employer/employer-details", { companyName, location, companyDescription, numberOfEmployees, industry, companyWebsite },
            {
                headers: {
